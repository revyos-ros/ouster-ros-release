## ouster-ros (jazzy) - 0.11.1-8

The packages in the `ouster-ros` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ouster-ros --override-release-repository-push-url git@github.com:revyos-ros/ouster-ros-release` on `Thu, 27 Jun 2024 12:33:58 -0000`
...
- release repository: https://github.com/revyos-ros/ouster-ros-release.git
- rosdistro version: `0.11.1-7`
- old version: `0.11.1-7`
- new version: `0.11.1-8`
...
## ouster-ros (jazzy) - 0.11.1-7

The packages in the `ouster-ros` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r jazzy ouster-ros --override-release-repository-push-url git@github.com:revyos-ros/ouster-ros-release.git` on `Sat, 15 Jun 2024 05:23:51 -0000`
